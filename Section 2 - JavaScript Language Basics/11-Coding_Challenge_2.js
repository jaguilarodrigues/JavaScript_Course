...
winner to the console. HINT: you will need the && operator 
to take the decision. If you can't solve this one, just 
...
switch (true)
{
    case (avgJohn >= avgMark && avgJohn >= avgMary):
        console.log('John\'s team win: ' + avgJohn + 'points');
        break;
    case (avgMark >= avgJohn && avgMark >= avgMary):
        console.log('Mark\'s team win: ' + avgJohn + 'points');
        break;
    case (avgMary >= avgJohn && avgMary >= avgMark):
        console.log('Mary\'s team win: ' + avgJohn + 'points');
        break;
    default:
